        ...
        <div className="flex flex-col min-h-screen">
                    ...
                    <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
                        <div className="flex flex-col justify-center space-y-4">
                            <div className="space-y-2">
                                <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">About Auto Repair
                                    Workshop</h1>
            ...
            <section className="w-full py-12 md:py-24 lg:py-32">
                <div className="container px-4 md:px-6">
                    <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
                        <div
                            className="relative h-[300px] md:h-[400px] overflow-hidden rounded-xl order-last lg:order-first">
                            <Image
                                src="/placeholder.svg?height=400&width=600"
                        ...
                        <div className="flex flex-col justify-center space-y-4">
                            <div className="space-y-2">
                                ...
                                <p className="text-zinc-500 dark:text-zinc-400">
                                    Founded in 2003 by master mechanic John Smith, Auto Repair Workshop began as a
                                    small, family-owned
                                    business dedicated to providing honest and reliable auto repair services to the
                                    local community.
                                </p>
                                <p className="text-zinc-500 dark:text-zinc-400">
                                    Over the years, we've grown into a full-service auto repair facility, but we've
                                    never lost sight of
                                    our core values: integrity, quality, and customer satisfaction. We treat every
                                    vehicle as if it were
                                    our own, and every customer like family.
                                </p>
                                <p className="text-zinc-500 dark:text-zinc-400">
                                    Today, our team of ASE-certified technicians continues to uphold these values while
                                    staying at the
                    ...
                    <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 mt-12">
                        <div className="flex flex-col items-center space-y-4">
                            ...
                            <div className="text-center">
                                ...
                                <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
                                    ASE Master Certified with over 25 years of experience. Specializes in engine
                                    performance and
                                    diagnostics.
                                </p>
                            </div>
                        ...
                        <div className="flex flex-col items-center space-y-4">
                            ...
                            <div className="text-center">
                                ...
                                <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
                                    15 years in automotive service management. Ensures every customer receives
                                    exceptional service.
                                </p>
                            </div>
                        </div>
                        <div className="flex flex-col items-center space-y-4">
                            ...
                            <div className="text-center">
                                ...
                                <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
                                    ASE Certified with 12 years of experience. Specializes in electrical systems and
                    ...
                    <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 mt-12">
                        <div className="flex flex-col items-center space-y-4 border p-6 rounded-lg">
                            ...
                            <p className="text-center text-zinc-500 dark:text-zinc-400">
                                We're honest about what your vehicle needs and transparent about our pricing. No
                                unnecessary repairs,
                                ever.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col items-center space-y-4 border p-6 rounded-lg">
                            ...
                            <p className="text-center text-zinc-500 dark:text-zinc-400">
                                We prioritize your satisfaction and work to build long-term relationships with our
                                customers.
                            </p>
                        </div>
                        <div className="flex flex-col items-center space-y-4 border p-6 rounded-lg">
                            ...
                            <p className="text-center text-zinc-500 dark:text-zinc-400">
                                We respect your time and work efficiently to get you back on the road as quickly as
                                possible.
                            </p>
                        </div>
                        <div className="flex flex-col items-center space-y-4 border p-6 rounded-lg">
                    ...
                    <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
                        <div className="flex flex-col justify-center space-y-4">
                            <div className="space-y-2">
                                ...
                                <p className="text-zinc-500 dark:text-zinc-400">
                                    We invest in ongoing training and certification to ensure our team has the knowledge
                                    and skills to
            ...
            <section className="w-full py-12 md:py-24 lg:py-32 bg-zinc-900 text-white">
                <div className="container px-4 md:px-6">
                    <div className="flex flex-col items-center justify-center space-y-4 text-center">
                        <div className="space-y-2">
                            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Experience the
                                Difference</h2>
