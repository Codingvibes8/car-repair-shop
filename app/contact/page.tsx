...
export default function ContactPage() {
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <section
                className="w-full flex flex-col items-center justify-center py-12 md:py-24 lg:py-32 bg-gradient-to-b from-slate-900 to-slate-700 text-white max-w-[1536px] mx-auto">
                <div className="container px-4 md:px-6">
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <p className="text-zinc-500 dark:text-zinc-400 mb-6">
                                    We're always happy to hear from our customers. Whether you need to schedule service,
                                    request a quote,
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-zinc-500 dark:text-zinc-400">123 Repair Lane, London N18
                                                7AW</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-zinc-500 dark:text-zinc-400">Monday - Friday: 8am -
                                                6pm</p>
                            ...
                            <div className="relative h-[300px] overflow-hidden rounded-xl">
                                <Image src="/placeholder.svg?height=300&width=500" alt="Map location" fill
            ...
            <section className="w-full py-12 md:py-24 lg:py-32 bg-zinc-100 dark:bg-zinc-800">
                <div className="container px-4 md:px-6">
                    <div className="flex flex-col items-center justify-center space-y-4 text-center">
                        <div className="space-y-2">
                            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Frequently Asked
                                Questions</h2>
                            <p className="max-w-[700px] text-zinc-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-zinc-400">
                    ...
                    <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-2 mt-12">
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <p className="text-zinc-500 dark:text-zinc-400">
                                    Yes, we provide free estimates for all repair and maintenance services. You can
                                    request an estimate by
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-zinc-500 dark:text-zinc-400">
                                    Service times vary depending on the type of service needed. Oil changes typically
                                    take 30-60 minutes,
                                    while more complex repairs may take several hours or days. We'll provide you with an
                                    estimated
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-zinc-500 dark:text-zinc-400">
                                    Yes, we stand behind our work with a 24-month/24,000-mile warranty on parts and
                                    labor for most
                                    repairs. Some services may have different warranty terms, which we'll discuss with
                                    you before
                                    beginning work.
                                </p>
                            </div>
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <p className="text-zinc-500 dark:text-zinc-400">
                                    Yes, our certified technicians are trained to work on domestic and import vehicles
                                    of all makes and
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-zinc-500 dark:text-zinc-400">
                                    Yes, we offer a complimentary local shuttle service to take you to work or home
                                    while your vehicle is
                                    being serviced. We also have loaner vehicles available for longer repairs, subject
                                    to availability.
                                </p>
                            </div>
                            <div className="space-y-2">
                                ...
                                <p className="text-zinc-500 dark:text-zinc-400">
                                    For most modern vehicles, we recommend an oil change every 5,000-7,500 miles or
                                    every 6 months,
                                    whichever comes first. However, this can vary based on your vehicle's make, model,
                                    age, and driving
                                    conditions. Consult your owner's manual or ask our technicians for a recommendation
                                    specific to your
                                    vehicle.
                                </p>
                            </div>
            ...
            <section className="w-full py-12 md:py-24 lg:py-32 bg-zinc-900 text-white">
                <div className="container px-4 md:px-6">
                    <div className="flex flex-col items-center justify-center space-y-4 text-center">
                        <div className="space-y-2">
                            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Ready to Schedule
                                Service?</h2>
